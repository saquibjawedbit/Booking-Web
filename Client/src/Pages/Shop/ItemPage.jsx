          ...
          <div className="space-y-6">
            <div>
              ...
              <p className="text-gray-600 text-lg leading-relaxed">
                {item.description ||
                  'This is a high-quality adventure gear item perfect for your outdoor adventures.'}
              </p>
            </div>
              ...
              <CardContent className="p-6">
                ...
                <div className="flex gap-2 mb-4">
                  {item.purchase && (
                    <Badge
                      variant={
                        selectedOption === 'purchase' ? 'default' : 'outline'
                      }
                  ...
                  {item.rent && (
                    <Badge
                      variant={
                        selectedOption === 'rent' ? 'default' : 'outline'
                      }
                      className="flex items-center gap-1 cursor-pointer"
