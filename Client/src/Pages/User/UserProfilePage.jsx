...
export default function UserProfilePage() {
  ...
  const userProfile = {
    ...
    nextLevel:
      user.user.nextLevel || Math.floor(user.user.level / 100) * 100 + 100, // Example calculation for next level
  };
  const progressPercentage =
    (userProfile.experience / userProfile.nextLevel) * 100;
  return (
    <UserLayout>
              ...
              <Card className="rounded-2xl border-gray-200">
                ...
                <CardContent className="space-y-6">
                  <div className="flex flex-col items-center">
                    ...
                    <Badge className="mt-2 bg-black text-white rounded-full">
                      {Math.floor(userProfile.level / 100)}
                    </Badge>
                  </div>
